...
(*The W1 represent Ce, C1 represent C3, and C3 represnt C1 in the *.tpl and *.est files in [models](https://github.com/qiangh06/Setaria-pan-genome/tree/main/Demographic%20history%20inference/models) folder)
